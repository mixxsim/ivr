...
if __name__ == '__main__':
    ...
    # addComment_handler = CommandHandler('addComment', addComment)
    get_my_recipes_handler = RegexHandler('^my recipes$', get_my_recipes)
    # getComment_handler = CommandHandler('getComment', seeComment)
    # like_handler = CommandHandler('like', like)
    # dislike_handler = CommandHandler('dislike', dislike)
    ...
    # dispatcher.add_handler(addComment_handler)
    dispatcher.add_handler(add_comment_conv_handler)
    # dispatcher.add_handler(getComment_handler)
    ...
    # dispatcher.add_handler(dislike_handler)
